...
class TypeConstraintsCollectorTest {
    ...
    fun ifTest() {
        ...
        Assert.assertEquals(Pair("int", ans), typeConsColl(if1, ident, 0, mutableListOf(), false, true))
        ...
        Assert.assertEquals(Pair("int", ans2), typeConsColl(if2, ident, 0, mutableListOf(), false, true))
    }
    ...
    fun letExplicit() {
        ...
        Assert.assertEquals(Pair("int", ans), typeConsColl(let1, ident, 0, mutableListOf(), false, true))
        println(ident.d)
        val ans6 = mutableListOf<String>()
        Assert.assertEquals(Pair("int", ans6), typeConsColl(defVar, ident, 0, mutableListOf(), false, true))
        ...
        Assert.assertEquals(Pair("int", ans2), typeConsColl(let2, ident, 0, mutableListOf(), false, true))
        println(ident.d)
        ...
        Assert.assertEquals(Pair("bool", ans3), typeConsColl(let3, ident, 0, mutableListOf(), false, true))
        println(ident.d)

        ident = identTable(hashMapOf())
        val ans4 = mutableListOf<String>("bool=bool", "bool=bool", "bool=bool")
        Assert.assertEquals(Pair("bool", ans4), typeConsColl(let4, ident, 0, mutableListOf(), false, true))
        println(ident.d)
        val ans5 = mutableListOf<String>()
        Assert.assertEquals(Pair("bool", ans5), typeConsColl(defVar, ident, 0, mutableListOf(), false, true))
    }
    ...
    /*fun letRecExplicit() {
        var ident = identTable(hashMapOf())
        var teste = typeConsColl(letRec1, ident, 0, mutableListOf(), false, true)
    ...
    fun fnExplicit(){ //depois que o joão adicionar os parênteses, fazer um teste passando uma funcao como parametro
        ...
        Assert.assertEquals(Pair("(int->bool)", ans), typeConsColl(fn1, ident, 0, mutableListOf(), false, true))
    }
    ...
    fun letRecExplicit(){
        ...
        Assert.assertEquals(Pair("X0", ans), typeConsColl(letRec2 , ident, 0, mutableListOf(), false, true))*/
        ...
        println(typeConsColl(letRec3 , ident2, 0, mutableListOf(), false, true))
        println(ident2.d)
        //Assert.assertEquals(Pair("z0", ans2), typeConsColl(letRec3 , ident2, 0, mutableListOf(), false, true))
    }*/
    ...
    fun tail(){
        var ident = identTable(hashMapOf())
        Assert.assertEquals(Pair("X0 list", mutableListOf<String>("int list=X0 list")),
            typeConsColl(tail, ident, 0, mutableListOf(), false, true)
        )

        var ident2 =
            identTable(hashMapOf()) //o tipo de tail(lista), para uma lista com apenas um elemento, será "tipo_elemento list"
        Assert.assertEquals(Pair("X0 list", mutableListOf<String>("int list=X0 list")),
            typeConsColl(tail2, ident2, 0, mutableListOf(), false, true)
        )
    }
    ...
    fun isEmpty(){
        var ident = identTable(hashMapOf())
        Assert.assertEquals(Pair("bool", mutableListOf<String>("X1 list=X0 list")),
            typeConsColl(isEmpty1, ident, 0, mutableListOf(), false, true)
        )

        var ident2 = identTable(hashMapOf())
        Assert.assertEquals(Pair("bool", mutableListOf<String>("int list=X0 list")),
            typeConsColl(isEmpty2, ident2, 0, mutableListOf(), false, true)
        )
