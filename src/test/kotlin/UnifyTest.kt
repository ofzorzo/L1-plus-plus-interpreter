...
class UnifyTest {
    ...
    fun ifTests() {
        ...
        // SUBSTITUIÇÕES: -
        val restrictionsIf1 = typeConsColl(
            TmIf(TmBool(true), num2, num3),
        ...
        // SUBSTITUIÇÕES: -
        val restrictionsIf2 = typeConsColl(
            TmIf(equal, TmBool(false), TmBool(true)),
            identTable(hashMapOf()), 0, mutableListOf(), true, false
        )
    ...
    fun ifErrorTests() {
        ...
        // SUBSTITUIÇÕES: - (UnifyFail())
        val restrictionsIf2 = typeConsColl(
            TmIf(TmBool(true), TmBool(false), num2),
            identTable(hashMapOf()), 0, mutableListOf(), true, false
        )
    ...
    fun letTests() {
        ...
        val restrictionsLet2 = typeConsColl(
            TmLet(x, TyInt(), num1, addCommand),
        ...
        val restrictionsMultiplication = typeConsColl(
            TmLet(x, TyInt(), num2, TmLet(y, TyInt(), num3, multCommand)),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
    ...
    fun letErrorTests() {
        ...
        val restrictionsAdd = typeConsColl(
            TmLet(x, TyInt(), num1, addCommand),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
        ...
        // SUBSTITUIÇÕES: - (UnifyFail())
        val multCommand = MulOp(x, y)
        val restrictionsMult = typeConsColl(
            TmLet(x, TyInt(), num2, TmLet(y, TyInt(), TmBool(true), multCommand)),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
    ...
    fun fnTests() {
        ...
        val x = TmVar("x")
        val equal = EqOp(x, x)
        val restrictionsFnEqual = typeConsColl(
            TmFn(x, TyInt(), equal),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
    ...
    fun headTests() {
        ...
        val restrictionHead1 = typeConsColl(
            TmHd(numList),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
        ...
        val restrictionHead2 = typeConsColl(
            TmHd(boolList),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
    ...
    fun tailTests() {
        ...
        // SUBSTITUIÇÕES: X0 list = int list
        val numList = TmList(Vnum(12), TmList(Vnum(-32), TmNil()))
        val restrictionTai11 = typeConsColl(
            TmTl(numList),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
        ...
        // SUBSTITUIÇÕES: X0 list = bool list
        val boolList = TmList(Vbool(false), TmList(Vbool(true), TmList(Vbool(false), TmNil())))
        val restrictionTail2 = typeConsColl(
            TmTl(boolList),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
    ...
    fun isEmptyTests() {
        ...
        val emptyList = TmNil()
        val restrictionIsEmpty1 = typeConsColl(
            TmIsEmpty(emptyList),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
        ...
        val restrictionIsEmpty2 = typeConsColl(
            TmIsEmpty(boolList),
            identTable(hashMapOf()), 0, mutableListOf(), false, true
        )
    ...
    fun staticFirstCaseTests() { // S = T
        ...
        Assert.assertEquals(mutableListOf<String>(),
            unify(mutableListOf("bool=bool", "int=int", "bool=bool"), mutableListOf())
        )
    }
    ...
    fun staticSecondCaseTests() { // S = X e X não pertence a T
        ...
        Assert.assertEquals(mutableListOf("X1=int", "X2=bool"),
            unify(mutableListOf("(X1->X2)=(int->bool)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X1=int", "X2=X3"),
            unify(mutableListOf("(X1->X2)=(int->X3)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X3=int", "X1=int", "X2=int"),
            unify(mutableListOf("(X1->X2)=(int->X3)", "X3=int"), mutableListOf())
        )
        ...
        Assert.assertEquals(mutableListOf("X1=int", "X2=int"),
            unify(mutableListOf("X1 List=X2 List", "X2=int"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X2=int", "X1=int"),
            unify(mutableListOf("(X2->X1 List)=(int->int List)"), mutableListOf())
        )
    }
    ...
    fun staticThirdCaseTests() { // T = X e X não pertence a S
        ...
        Assert.assertEquals(mutableListOf("X1=int", "X2=bool"),
            unify(mutableListOf("(int->bool)=(X1->X2)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X1=int", "X2=X3"),
            unify(mutableListOf("(int->X2)=(X1->X3)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X3=int", "X1=int", "X2=int"),
            unify(mutableListOf("(int->X3)=(X1->X2)", "int=X3"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X4=int", "X5=bool", "X6=int", "X3=bool", "X1=int", "X2=int"),
    ...
    fun staticFourthCaseTests() { // T = T1->T2 e W = S1->S2
        ...
        Assert.assertEquals(mutableListOf<String>(),
            unify(mutableListOf("(int->int)=(int->int)", "((bool->int)->bool)=((bool->int)->bool)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf<String>(),
            unify(mutableListOf("((((int->bool)->int)->bool)->int)=((((int->bool)->int)->bool)->int)"), mutableListOf())
        )
    }
    ...
    @Test
    fun staticListTest() {
        Assert.assertEquals(mutableListOf("X1 list=int list"),
            unify(mutableListOf("int list=X1 list"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X1 list=int list"),
            unify(mutableListOf("X1 list=int list"), mutableListOf())
        )
    }
    ...
    fun staticComplexFunctionsTest() {
        Assert.assertEquals(mutableListOf("X3=bool", "X1=int", "X2=int"),
            unify(mutableListOf("((X1->X2)->X3)=((int->int)->bool)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X1=(int->int)", "X2=int"),
            unify(mutableListOf("(X1->X2)=((int->int)->int)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X3=int", "X1=(int->int)", "X2=int"),
            unify(mutableListOf("((X1->X2)->X3)=(((int->int)->int)->int)"), mutableListOf())
        )
        Assert.assertEquals(mutableListOf("X3=bool", "X1=int", "X2=int"),
            unify(mutableListOf("((X1->X2)->X3)=((int->int)->bool)"), mutableListOf())
        )
    ...
    fun staticFunctionPartsCollectorTest() {
        ...
        Assert.assertEquals(mutableListOf("((int->int)->int)", "bool"),
            collectFunctionParts("(((int->int)->int)->bool)")
        )
        Assert.assertEquals(mutableListOf("((int->int)->int)", "(int->bool)"),
            collectFunctionParts("(((int->int)->int)->(int->bool))")
        )
        Assert.assertEquals(mutableListOf("((int->int)->int)", "((bool->bool)->int)"),
            collectFunctionParts("(((int->int)->int)->((bool->bool)->int))")
        )
        Assert.assertEquals(mutableListOf("int->int", "int"), collectFunctionParts("(int->int->int)"))
