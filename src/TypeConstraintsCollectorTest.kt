...
class TypeConstraintsCollectorTest {
    ...
    fun tail(){
        var ident = identTable(hashMapOf())
        Assert.assertEquals(Pair("X0 list", mutableListOf<String>("int list=X0 list")), typeConsColl(tail, ident, 0, mutableListOf(), false, true))

        var ident2 = identTable(hashMapOf()) //o tipo de tail(lista), para uma lista com apenas um elemento, será "tipo_elemento list"
        Assert.assertEquals(Pair("X0 list", mutableListOf<String>("int list=X0 list")), typeConsColl(tail2, ident2, 0, mutableListOf(), false, true))
    }
    ...
    fun isEmpty(){
        var ident = identTable(hashMapOf())
        Assert.assertEquals(Pair("bool", mutableListOf<String>("X1 list=X0 list")), typeConsColl(isEmpty1, ident, 0, mutableListOf(), false, true))

        var ident2 = identTable(hashMapOf())
        Assert.assertEquals(Pair("bool", mutableListOf<String>("int list=X0 list")), typeConsColl(isEmpty2, ident2, 0, mutableListOf(), false, true))
